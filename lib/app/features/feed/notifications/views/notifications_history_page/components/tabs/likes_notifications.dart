...
import 'package:ion/app/features/feed/notifications/providers/notification_likes_provider.c.dart';
...
class LikesNotifications extends HookConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final likes = ref.watch(notificationLikesProvider).valueOrNull;
    ...
    return PullToRefreshBuilder(
      ...
      onRefresh: () async => ref.invalidate(notificationLikesProvider),
