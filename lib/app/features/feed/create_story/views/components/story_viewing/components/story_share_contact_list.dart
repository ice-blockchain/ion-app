...
class StoryShareContactsList extends ConsumerWidget {
  const StoryShareContactsList({super.key});
        ...
        return ScreenSideOffset.small(
          child: Padding(
            ...
            child: ListItem.user(
              ...
              onTap: () =>
                  ref.read(storyShareControllerProvider.notifier).toggleContact(contact.id),
              trailing: isSelected
