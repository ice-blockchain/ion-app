...
class TextEditorItalicButton extends HookWidget {
  ...
  TextEditorItalicButton(this._controller);
  ...
  Widget build(BuildContext context) {
    ...
    useEffect(() {
      final listener = () {
        ...
        isActive.value = style.attributes.containsKey(Attribute.italic.key);
      };
    ...
    return GestureDetector(
      onTap: () {
        _controller.formatSelection(
          isActive.value ? Attribute.clone(Attribute.italic, null) : Attribute.italic,
        );
      },
      child: Container(
