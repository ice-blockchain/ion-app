...
extension UserMetadataEntityExtension on UserMetadataEntity {
  Future<EventMessageMetadataDbModel> toEventMessageDbModel() async {
    final eventMessage = await toEventMessage(data);
    return EventMessageMetadataDbModel(
      id: eventMessage.id,
  ...
  static UserMetadataEntity fromEventMessageDbModel(EventMessageMetadataDbModel model) {
