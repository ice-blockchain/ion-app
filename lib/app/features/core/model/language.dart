...
enum Language {
  ...
  divehi(name: 'Divehi', localName: '', flag: '🇲🇻', isoCode: 'dv'),
  dutch(name: 'Dutch', localName: 'Nederlands', flag: '🇳🇱', isoCode: 'nl'),
  esperanto(name: 'Esperanto', localName: '', flag: '🌍', isoCode: 'eo'),
  ...
  haitianCreole(name: 'Haitian Creole', localName: '', flag: '🇭🇹', isoCode: 'ht'),
  ...
  tagalog(name: 'Tagalog', localName: '', flag: '🇵🇭', isoCode: 'tl'),
