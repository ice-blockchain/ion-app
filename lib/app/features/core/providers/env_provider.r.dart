...
class Env extends _$Env {
  ...
  T get<T>(EnvVariable variable) {
    return switch (variable) {
      ...
      EnvVariable.AF_IOS_APP_ID => const String.fromEnvironment('AF_IOS_APP_ID') as T,
      EnvVariable.AF_ANDROID_APP_ID => const String.fromEnvironment('AF_ANDROID_APP_ID') as T,
