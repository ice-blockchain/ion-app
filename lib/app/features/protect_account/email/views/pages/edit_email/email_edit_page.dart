...
class EmailEditPage extends ConsumerWidget {
  const EmailEditPage(this.step, this.email, {super.key});

  final EmailEditSteps step;
  final String? email;

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    return SheetContent(
      body: step == EmailEditSteps.success
          ? Padding(
              ...
              slivers: [
                SliverAppBar(
                  ...
                  flexibleSpace: NavigationAppBar.modal(
                    showBackButton: step != EmailEditSteps.success,
                    actions: const [
                ...
                SliverFillRemaining(
                  ...
                  child: Column(
                    children: [
                      ...
                      if (step == EmailEditSteps.input)
                        const Expanded(
                          child: EmailSetupInputPage(),
                        ),
                      if (step == EmailEditSteps.confirmation)
                        Expanded(
