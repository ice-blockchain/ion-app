...
class SelectNetworkList extends ConsumerWidget {
          ...
          Expanded(
            child: ScreenSideOffset.small(
              child: ListView.separated(
                ...
                itemBuilder: (context, index) => _NetworkItem(network: networks[index]),
