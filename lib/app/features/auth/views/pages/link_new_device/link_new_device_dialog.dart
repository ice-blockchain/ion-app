...
class LinkNewDeviceDialog extends ConsumerWidget {
  ...
  Future<void> _addDelegation(WidgetRef ref) async {
    ...
    final isOnboardingComplete = await ref.read(onboardingCompleteProvider.future);
    if ((isOnboardingComplete ?? false) && ref.context.mounted) {
