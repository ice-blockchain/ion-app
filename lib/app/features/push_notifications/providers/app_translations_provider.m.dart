...
class PushNotificationTranslations
  ...
  const factory PushNotificationTranslations({
    ...
    required NotificationTranslation reply,
    required NotificationTranslation mention,
    required NotificationTranslation repost,
    required NotificationTranslation like,
    required NotificationTranslation follower,
    required NotificationTranslation paymentRequest,
    required NotificationTranslation paymentReceived,
    required NotificationTranslation chatDocumentMessage,
    required NotificationTranslation chatEmojiMessage,
    required NotificationTranslation chatPhotoMessage,
    required NotificationTranslation chatProfileMessage,
    required NotificationTranslation chatReaction,
    required NotificationTranslation chatSharePostMessage,
    required NotificationTranslation chatShareStoryMessage,
    required NotificationTranslation chatSharedStoryReplyMessage,
    required NotificationTranslation chatTextMessage,
    required NotificationTranslation chatVideoMessage,
    required NotificationTranslation chatVoiceMessage,
    required NotificationTranslation chatAlbumMessage,
