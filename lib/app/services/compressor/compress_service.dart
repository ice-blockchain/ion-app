...
class CompressionService {
  ...
  ///
  /// If any errors occur during compression, they are logged, and an exception is thrown.
  ///
  /// Throws:
  /// - [Exception] if compression fails due to invalid input or other errors.
  ///
  ...
  ///
  /// Throws:
  /// - [Exception] if decompression fails due to invalid input or other errors.
  ///
