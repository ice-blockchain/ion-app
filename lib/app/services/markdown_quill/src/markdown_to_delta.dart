...
import 'package:ion/app/services/markdown_quill/src/custom_quill_attributes.dart';
import 'package:ion/app/services/markdown_quill/src/utils.dart';
...
class MarkdownToDelta extends Converter<String, Delta> implements md.NodeVisitor {
  ...
  String _trimTextToMdSpec(String text) {
    ...
    final softLineBreakRegExp = RegExp(r' ?\n *');
    ...
    return result.replaceAll(softLineBreakRegExp, ' ');
  }
