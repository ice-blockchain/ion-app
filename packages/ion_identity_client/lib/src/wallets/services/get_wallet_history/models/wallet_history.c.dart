...
import 'package:ion_identity_client/src/wallets/services/get_wallet_history/models/wallet_history_record.c.dart';

part 'wallet_history.c.freezed.dart';
part 'wallet_history.c.g.dart';
