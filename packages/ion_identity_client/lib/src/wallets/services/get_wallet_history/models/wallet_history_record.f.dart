...
import 'package:ion_identity_client/src/wallets/services/get_wallet_history/models/wallet_history_metadata.f.dart';

part 'wallet_history_record.f.freezed.dart';
part 'wallet_history_record.f.g.dart';
