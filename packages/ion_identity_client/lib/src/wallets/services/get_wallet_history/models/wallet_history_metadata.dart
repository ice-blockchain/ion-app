...
import 'package:ion_identity_client/src/wallets/services/get_wallet_history/models/wallet_history_asset_metadata.dart';

part 'wallet_history_metadata.freezed.dart';
part 'wallet_history_metadata.g.dart';
