...
/// Implementation of UserActionSignerNew that uses passkey authentication.
class PasskeyUserActionSigner implements UserActionSignerNew {
  const PasskeyUserActionSigner({
  ...
  Future<T> sign<T>(
    ...
    return userActionSigner.signWithPasskey(request, responseDecoder);
  }
}
