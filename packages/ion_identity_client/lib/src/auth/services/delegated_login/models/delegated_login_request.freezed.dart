...
class _$DelegatedLoginRequestImpl implements _DelegatedLoginRequest {
  const _$DelegatedLoginRequestImpl({required this.username});
  ...
  @override
  String toString() {
    return 'DelegatedLoginRequest(username: $username)';
  }
...
abstract class _DelegatedLoginRequest implements DelegatedLoginRequest {
  const factory _DelegatedLoginRequest({required final String username}) =
      _$DelegatedLoginRequestImpl;
