...
class NetworksTable extends Table with TableInfo<NetworksTable, NetworksTableData> {
  ...
  late final GeneratedColumn<String> explorerUrl = GeneratedColumn<String>(
      ...
      type: DriftSqlType.string, requiredDuringInsert: true);
  late final GeneratedColumn<int> tier = GeneratedColumn<int>('tier', aliasedName, false,
      type: DriftSqlType.int,
      requiredDuringInsert: false,
      defaultValue: const CustomExpression('1'));
  @override
  List<GeneratedColumn> get $columns => [id, image, isTestnet, displayName, explorerUrl, tier];
  @override
  String get aliasedName => _alias ?? actualTableName;
  @override
  String get actualTableName => $name;
  ...
  NetworksTableData map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return NetworksTableData(
      ...
      tier: attachedDatabase.typeMapping.read(DriftSqlType.int, data['${effectivePrefix}tier'])!,
    );
  }
...
class NetworksTableData extends DataClass implements Insertable<NetworksTableData> {
  ...
  @override
  int get hashCode => Object.hash(id, image, isTestnet, displayName, explorerUrl, tier);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
